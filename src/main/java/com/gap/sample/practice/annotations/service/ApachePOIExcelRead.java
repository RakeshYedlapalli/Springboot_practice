...
public class ApachePOIExcelRead {
    ...
    private static final String FILE_NAME = "/Users/yadlapallirakesh/Documents/ExtractDataFromServer/MissingAccs/missing_acc_id.xlsx";
            ...
            while (iterator.hasNext()) {
                ...
                while (cellIterator.hasNext()) {
                    ...
                    if (currentCell.getCellTypeEnum() == CellType.STRING) {
                       // System.out.printInForwardDirection(currentCell.getStringCellValue() + "--");
